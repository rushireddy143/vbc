...
public class procOfficer {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		d.findElement(By.xpath("//input[@name='username']")).sendKeys("procofficer");
		
		d.findElement(By.id("password")).sendKeys("Welcome@123");
		
		d.findElement(By.xpath("//button[@id='loginBtn']")).click();

         d.findElement(By.xpath("//div[@class='small-box bg-green']/a")).click();
         Thread.sleep(5000);
         d.findElement(By.linkText("10196")).click();
 		d.findElement(By.id("Approved")).click();
 		d.findElement(By.xpath("//textarea[@id='comment']")).sendKeys("Approved by ProcOfficer");
